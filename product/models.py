...
class Product(models.Model):
    ...
    meta_title = models.CharField(max_length=255, null=True,blank=True,help_text='Nên nằm trong khoảng 55-70 kí tự')
    meta_description = models.CharField(max_length=255, null=True,blank=True,help_text='Nên nằm trong khoảng 155-160 kí tự')
    ...
    discount = models.DecimalField(max_digits=4, decimal_places=2, default=0,help_text='Chấp nhận giá trị từ 0 - 70 (%)')
    ...
    thumbnail = models.ImageField(upload_to=get_upload_to, null=True,blank=True,default=None, help_text='Kích thước 400x400px')
